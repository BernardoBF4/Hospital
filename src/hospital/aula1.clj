...
(defn simula-um-dia
  []
  ; root bindin: todas as thread têm acesso a esse símbole, dentro desse namespace
  ...
  ; Funciona, mas já começamos a ter um treco no coração, porque temos um símbolo global,
  ; com root binding, sendo alterado a rodo
  (pprint hospital)
  ...
  (def hospital (h.logic/chega-em hospital :espera "660"))
